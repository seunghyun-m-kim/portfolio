...
def process_log_file(cur, filepath):
    ...
    time_data = [df['ts'].tolist(), t.dt.hour.tolist(), t.dt.day.tolist(), t.dt.week.tolist(), t.dt.month.tolist(), t.dt.year.tolist(), t.dt.weekday.tolist()]
    column_labels = ["start_time", "hour", "day", "week", "month", "year", "weekday"]
    d = {}
    for x, y in zip(column_labels, time_data):
        d[x] = y
