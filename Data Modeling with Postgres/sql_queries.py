...
songplays (songplay_id SERIAL PRIMARY KEY, start_time bigint NOT NULL, user_id varchar NOT NULL, level varchar, song_id varchar, artist_id varchar, session_id numeric, location varchar, user_agent varchar);
""")
...
song_table_create = ("""
CREATE TABLE IF NOT EXISTS
songs (song_id varchar PRIMARY KEY, title varchar, artist_id varchar NOT NULL, year numeric, duration numeric);
""")
...
time_table_create = ("""
CREATE TABLE IF NOT EXISTS
time (start_time bigint PRIMARY KEY, hour int, day int, week int, month int, year int, weekday int)
""")
